...
const FAQS = [
  ...
  { id: 6, command: 'send <amount> <token name> to <w-address>', description: 'e.g. send 1 dak to 0xd9F016e453dE48D877e3f199E8FA4aADca2E979C' },
  { id: 7, command: 'check pnl <token name> <amount> to <dest>', description: 'e.g. check pnl mon 1 to usdc (simulated result at the moment)' },
  { id: 8, command: 'record stats', description: 'After checking a pnl you can do a follow up command "> record stats" to record your pnl onchain' },
  { id: 9, command: 'achievements', description: 'Will show all the available achievements (soulbound)' },
  { id: 10, command: 'mint <achievement_name>', description: 'Once you are eligible type e.g. "> mint profit initiate", it will mint your achievement and put a record onchain' },
  { id: 11, command: 'analyze', description: 'Analyze the user wallets and show the wallet Monad Interactions including Total Transactions, Interactions with known Tokens, NFTs that guarantee a mint on mainnet, and the list of Featured Testnet NFTs that you might want to hold' },
  { id: 12, command: 'check balance <token name>', description: 'e.g. check balance mon' },
  { id: 13, command: 'show my nfts', description: 'Will show all the user owned NFTs but have a maximum limit of 100' },
  { id: 14, command: 'best price for <token name> <amount> to <dest>', description: 'e.g. best price for mon 1 to usdc (simulated result at the moment)' },
  { id: 15, command: 'token report <token name> <amount> to <dest>', description: 'e.g. token report dak 1 to usdc, will show a 3–7 days historical report of the token (simulated result at the moment)' },
];
